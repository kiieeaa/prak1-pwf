                ...
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kategori" id="kategori" value="{{ old('kategori', $product->kategoris->first()->name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            @error('kategori')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
